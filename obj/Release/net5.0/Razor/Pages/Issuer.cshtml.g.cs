#pragma checksum "C:\Users\rogulati\OneDrive - Microsoft\ID CxP\Projects\DID\Interop\VC Interop Test site\Pages\Issuer.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c3ac14de2dcddf7966c5f5cc572ecba78b2503b8"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c3ac14de2dcddf7966c5f5cc572ecba78b2503b8", @"/Pages/Issuer.cshtml")]
    ...
    #nullable disable
    {
        ...
        {
#nullable restore
#line 3 "C:\Users\rogulati\OneDrive - Microsoft\ID CxP\Projects\DID\Interop\VC Interop Test site\Pages\Issuer.cshtml"
...
#nullable disable
            WriteLiteral(@"            <div style=""text-align: center;"">
                ...
                <h1>Verifiable Credential Issuance</h1>
            ...
            <div id=""message-wrapper"" class=""margi");
            WriteLiteral(@"n-bottom-75 margin-top-75"" style=""display: none"">
           ...
           ");
            WriteLiteral(@" if (/Android/i.test(navigator.userAgent)) {
                ...
                if (respIssuanceReq.pin) {
                    document.getElementById('pinCodeText').innerHTML = ""Pin ");
            WriteLiteral(@"code: "" + respIssuanceReq.pin;
            ...
            WriteLiteral(@""";
                                ...
                                if (respMsg.status == 'issuance_error') {
                                    document.getElementById('pinCodeText').style.display = ""none"";
                             ");
            WriteLiteral(@"       document.getElementById('message').innerHTML = ""Issuance error occured, did you enter the wrong pincode? Please refresh the page and try again."";
